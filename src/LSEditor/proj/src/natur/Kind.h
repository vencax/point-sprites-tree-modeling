...
// methods ///////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	string defaultResPath;

private: unsigned int m_treeRandSeed;
public:	void SetTreeRand( unsigned int i)	{	m_treeRandSeed = i;	}

		
		inline CNO *GetTree( void) {	
			if( m_forest.size( ) ) 
				return *(m_forest.begin( ) );
			else
				return NULL;
		}
		void DeleteTree( void)	{	delete *(m_forest.begin( ));	m_forest.clear( );	}
